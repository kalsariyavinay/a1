							...
							<div class="row col-mb-50">
								...
								<div class="col-md-5 col-lg-12">
									...
									<div class="widget subscribe-widget">
										...
										<form id="widget-subscribe-form" action="{{asset('frontend/include/subscribe.php')}}" method="post" class="mb-0">
				...
				<div class="container">
					...
					<div class="row col-mb-30">
						...
						<div class="col-md-6 text-center text-md-start">
							...
							<div class="copyright-links"><a href="{{route('contactus')}}">Contact-Us</a> /<a href="#">Terms of Use</a> / <a href="#">Privacy Policy</a></div>
