    ...
    <div id="header-wrap">
        <div class="container">
            <div class="header-row">
                <div id="logo">
                    <a href="index.html">
                        <img class="logo-default" srcset="{{ asset('frontend/images/logo.png')}}, {{ asset('frontend/images/logo@2x.png')}} 2x" src="{{ asset('frontend/images/logo@2x.png')}}" alt="Canvas Logo">
                        <img class="logo-dark" srcset="{{ asset('frontend/images/logo-dark.png')}}, {{ asset('frontend/images/logo-dark@2x.png')}} 2x" src="{{ asset('frontend/images/logo-dark@2x.png')}}" alt="Canvas Logo">
                    </a>
                </div>
                ...
                <nav class="primary-menu">
                    <ul class="menu-container">
                        ...
                        <li class="menu-item mega-menu">
                            <a class="menu-link" href="{{route('portfolioview')}}">
                                <div>@lang('header.Portfolio')</div>
                            </a>
                            {{-- <div class="mega-menu-content mega-menu-style-2">
                        ...
                        <li class="menu-item mega-menu">
                            <a class="menu-link" href="{{route('blogview')}}">
                                <div>@lang('header.Blog')</div>
                            </a>
                            {{-- <div class="mega-menu-content mega-menu-style-2">
                        ...
                        <li class="menu-item mega-menu">
                            <a class="menu-link" href="#">
                                <div>@lang('header.Shortcodes')</div>
                            </a>
                            {{-- <div class="mega-menu-content">
                        ...
                        <li class="menu-item mega-menu">
                            ...
                            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                                ...
                                @else
                                <a href="{{ route('login') }}">@lang('header.Log in')</a>

                                @if (Route::has('register'))
                                <a href="{{ route('register') }}" style="margin-left: 10px">@lang('header.Register')</a>
                                @endif
                                @endauth
                            </div>
                            @endif
                        ...
                        <div>
                            <select class="Langchange btn btn- dropdown-toggle">
