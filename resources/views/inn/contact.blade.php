							...
							<div class="portfolio-image">
								...
								<div class="bg-overlay">
									...
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										...
										<a href="{{ asset('frontend/images/portfolio/full/1.jpg')}}" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="uil uil-plus"></i></a>
							...
							<div class="portfolio-image">
								...
								<div class="bg-overlay">
									...
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										...
										<a href="{{ asset('frontend/images/portfolio/full/2.jpg')}}" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="uil uil-plus"></i></a>
							...
							<div class="portfolio-image">
								...
								<div class="bg-overlay">
									...
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										...
										<a href="https://vimeo.com/89396394" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="iframe"><i class="uil uil-play"></i></a>
						...
						<div class="grid-inner">
							...
							<div class="portfolio-image">
								...
								<a href="portfolio-single.html">
									...
									<img src="{{ asset('frontend/images/portfolio/4/4.jpg')}}" alt="Open Imagination">
								...
								<div class="bg-overlay" data-lightbox="gallery">
									...
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										...
										<a href="{{ asset('frontend/images/portfolio/full/4.jpg')}}" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="gallery-item"><i class="uil uil-images"></i></a>

										<a href="{{ asset('frontend/images/portfolio/full/4-1.jpg')}}" class="d-none" data-lightbox="gallery-item"></a>
							...
							<div class="portfolio-image">
								...
								<div class="bg-overlay">
									...
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										...
										<a href="{{ asset('frontend/images/portfolio/full/5.jpg')}}" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="uil uil-plus"></i></a>
						...
						<div class="grid-inner">
							...
							<div class="portfolio-image">
								...
								<a href="portfolio-single.html">
									...
									<img src="{{ asset('frontend/images/portfolio/4/6.jpg')}}" alt="Open Imagination">
								...
								<div class="bg-overlay" data-lightbox="gallery">
									...
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										...
										<a href="{{ asset('frontend/images/portfolio/full/6.jpg')}}" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="gallery-item"><i class="uil uil-images"></i></a>

										<a href="{{ asset('frontend/images/portfolio/full/6-1.')}}" class="d-none" data-lightbox="gallery-item"></a>

										<a href="{{ asset('frontend/images/portfolio/full/6-2.jpg')}}" class="d-none" data-lightbox="gallery-item"></a>

										<a href="{{ asset('frontend/images/portfolio/full/6-3.jpg')}}" class="d-none" data-lightbox="gallery-item"></a>

										<a href="portfolio-single-gallery.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="uil uil-ellipsis-h"></i></a>
							...
							<div class="portfolio-image">
								...
								<div class="bg-overlay">
									...
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										...
										<a href="https://www.youtube.com/watch?v=kuceVNBTJio" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="iframe"><i class="uil uil-play"></i></a>
							...
							<div class="portfolio-image">
								...
								<div class="bg-overlay">
									...
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										...
										<a href="{{ asset('frontend/images/portfolio/full/8.jpg')}}" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="uil uil-plus"></i></a>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="entry">
								...
								<div class="entry-image">
									...
									<a href="#"><img src="{{ asset('frontend/images/magazine/thumb/1.jpg')}}" alt="Image" class="rounded"></a>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="entry">
								...
								<div class="entry-image">
									...
									<a href="#"><img src="{{ asset('frontend/images/magazine/thumb/2.jpg')}}" alt="Image" class="rounded"></a>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="entry">
								...
								<div class="entry-image">
									...
									<a href="#"><img src="{{ asset('frontend/images/magazine/thumb/3.jpg')}}" alt="Image" class="rounded"></a>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="entry">
								...
								<div class="entry-image">
									...
									<a href="#"><img src="{{ asset('frontend/images/magazine/thumb/4.jpg')}}" alt="Image" class="rounded"></a>
